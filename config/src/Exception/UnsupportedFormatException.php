...
/**
 * The filename given was not found or unreadable when attempting to load the configuration file
 *
...
class UnsupportedFormatException extends \abc\Config\ConfigException
{
